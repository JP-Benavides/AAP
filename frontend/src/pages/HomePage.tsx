...
export function HomePage() {
  const featuredClubs = [
    {
      ...
      description:
        "Connecting students passionate about science, technology, engineering, and mathematics.",
      category: "Academic",
      memberCount: 150,
    },
    {
  ...
  const testimonials = [
    {
      quote:
        "AAP has been instrumental in my academic journey. The community support and resources have helped me excel in ways I never thought possible.",
      author: "Sarah Chen",
      role: "Computer Science, Class of 2025",
    },
    {
      quote:
        "The connections I made through AAP clubs have opened doors to amazing opportunities. This program truly transforms the student experience.",
      author: "Michael Torres",
      role: "Business Administration, Class of 2024",
    },
    {
      quote:
        "Being part of AAP leadership taught me valuable skills in organization and community building that I use every day.",
      ...
      <section className="relative bg-gradient-to-br from-[#57068C] via-[#7208B8] to-[#8B4FC4] text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl mb-6">Academic Achievement Program</h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/clubs">
                <Button
                  size="lg"
                  className="bg-white text-[#57068C] hover:bg-gray-100 rounded-xl w-full sm:w-auto"
                >
                  Explore Clubs
                </Button>
              </Link>
              <Link to="/events">
                <Button
                  size="lg"
                  variant="outline"
                  className="border-white text-white hover:bg-white/10 rounded-xl w-full sm:w-auto"
                >
                  Upcoming Events
                </Button>
              </Link>
